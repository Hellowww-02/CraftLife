...
SHOP_ITEMS = {
    ...
    # Weapons
    "storm_blade":     {"name": "Storm Blade",     "icon": "🌩️", "cost": 850,
                        "type": "weapon",    "desc": "Slash with thunder speed",
                        "buff": {"boss_dmg": 12, "crit_chance": 10},
                        "buff_desc": "+12 Boss DMG, +10% Crit Chance"},
    ...
    "dragon_breath":   {"name": "Dragon's Breath", "icon": "🐉", "cost": 240,
                        ...
                        "buff_desc": "Use: +60 MP"},
    # Legendary
    "dragon_egg":      {"name": "Dragon Egg",      "icon": "🐲", "cost": 1400,
                        "type": "legendary", "desc": "Slumbering ancient power",
                        "buff": {"xp_pct": 14, "gold_pct": 14, "boss_dmg": 12},
                        "buff_desc": "+14% XP, +14% Gold, +12 Boss DMG"},
...
def complete_pomodoro(user_id, duration_minutes, task_name=""):
    ...
    conn.execute(
        ...
        (user_id, (task_name or "").strip(), minutes, xp, gold, local_now().isoformat())
    )
    conn.commit()
    conn.close()
