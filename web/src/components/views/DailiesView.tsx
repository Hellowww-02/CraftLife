        ...
        {filteredDailies.map((daily, idx) => {
          ...
          return (
            <div
              ...
              className={`ct-task-card p-4.5 flex flex-col justify-between gap-4 cursor-grab ${
              ...
              <div>
                <div className="flex items-start justify-between gap-2 mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    {daily.isFrozen && (
                      <span className="ct-chip px-2 py-0.5 text-[10px] font-bold text-cyan-300 border-cyan-500/40 bg-cyan-500/15 flex items-center gap-1">
                        <Snowflake className="w-3 h-3" /> {t('daily_frozen', 'Frozen')}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="ct-act text-cyan-400"
                      title={t('daily_freeze_tooltip', 'Freeze streak with Ice Shield')}
                    >
                    ...
                    <button
                      ...
                      className="ct-act text-slate-400"
                      title={t('daily_edit_daily', 'Edit Daily')}
                    >
            ...
            <form onSubmit={handleSave} className="space-y-3.5 text-xs">
              <div>
                ...
                <input
                  ...
                  placeholder={t('ph_e_g_20_pushups_stretching', 'e.g. 20 Pushups & Stretching')}
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={t('ph_routine_instructions', 'Routine instructions...')}
                  className="ct-input w-full px-3 py-2 rounded-xl focus:border-transparent"
                />
              </div>
