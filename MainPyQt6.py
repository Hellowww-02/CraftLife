...
from PyQt6.QtGui import QColor, QDrag, QFont, QFontMetrics, QIcon, QKeySequence, QPen, QShortcut, QTextCharFormat, QTextCursor, QPainter, QPixmap
...
class SportTrackPage(QWidget):
    ...
    def _build(self):
        ...
        # ── Stats strip reps: hari ini, 7 hari, rank terbaik ──
        stats_w = QWidget()
        stats_h = QHBoxLayout(stats_w)
        stats_h.setContentsMargins(0, 0, 0, 0)
        stats_h.setSpacing(10)
        ...
        root.addWidget(self._reps_chart)
